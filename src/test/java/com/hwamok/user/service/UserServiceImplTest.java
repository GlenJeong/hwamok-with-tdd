...
//        assertThat(userOne.getLoginId()).isEqualTo(user.getLoginId());
    ...
    void 회원_수정_성공() throws Exception {
        User user = userRepository.save(new User("jyb0120", "1234", "jyb1624@test.com", "Glenn", "정인범", "ACTIVATED", "1988-02-26"));

        User foundUserId = userRepository.findByLoginId(user.getLoginId()).orElseThrow();

        foundUserId = userService.updateProfile(foundUserId.getId(), "jyb1234", "4321", "jyb0226@test.com", "Glenn", "인범", "INACTIVATED", "1988-02-26");
...
//        assertThat(user.getId()).isNotNull();
    ...
    void 회원_수정_실패_loginId_null_혹은_빈값(String loginId) throws Exception {
       ...
       assertThatIllegalArgumentException().isThrownBy(()->userService.updateProfile(foundLoginId.getId(), loginId,"4321", "jyb0226@test.com", "Glenn", "인범", "INACTIVATED", "1988-02-26"));
    ...
    void 회원_수정_실패_password_null_혹은_빈값(String password) throws Exception {
        ...
        assertThatIllegalArgumentException().isThrownBy(()->userService.updateProfile(foundLoginId.getId(), "jyb0226",password, "jyb0226@test.com", "Glenn", "인범", "INACTIVATED", "1988-02-26"));
    ...
    void 회원_수정_실패_email_null_혹은_빈값(String email) throws Exception {
        ...
        assertThatIllegalArgumentException().isThrownBy(()->userService.updateProfile(foundLoginId.getId(), "jyb0226","4321", email, "Glenn", "인범", "INACTIVATED", "1988-02-26"));
    ...
    void 회원_수정_실패_name_null_혹은_빈값(String name) throws Exception {
        ...
        assertThatIllegalArgumentException().isThrownBy(()->userService.updateProfile(foundLoginId.getId(), "jyb0226","4321", "jyb11624@test.com", "Glenn", name, "INACTIVATED", "1988-02-26"));
    ...
    void 회원_수정_실패_loginId_11글자_이상() throws Exception {
        ...
        assertThatIllegalArgumentException().isThrownBy(() -> userService.updateProfile(foundLoginId.getId(), "jyb0226jyb0226", "4321", "jyb0226@test.com", "Glen", "인범", "INACTIVATED", "1988-01-20"));
    ...
    void 회원_수정_실패_password_31글자_이상() throws Exception {
        ...
        assertThatIllegalArgumentException().isThrownBy(() -> userService.updateProfile(foundLoginId.getId(), "jyb0226jyb0226", "109876543211098765432110987654321", "jyb0226@test.com", "Glen", "인범", "INACTIVATED", "1988-01-20"));
    ...
    void 회원_수정_실패_email_31글자_이상() throws Exception {
        ...
        assertThatIllegalArgumentException().isThrownBy(() -> userService.updateProfile(foundLoginId.getId(), "jyb0226jyb0226", "4321", "jyb0226jyb0226jyb0226123@test.com", "Glen", "인범", "INACTIVATED", "1988-01-20"));
    ...
    void 회원_수정_실패_name_11글자_이상() throws Exception {
        ...
        assertThatIllegalArgumentException().isThrownBy(() -> userService.updateProfile(foundLoginId.getId(), "jyb0226", "4321", "jyb0226@test.com", "Glen", "낙엽이흐드러지는가을저녁", "INACTIVATED", "1988-01-20"));
